...
##
golem::fill_desc(
  pkg_name = "css2r", # The name of the golem package containing the app (typically lowercase, no underscore or periods)
...
usethis::use_code_of_conduct(contact = "css2r@thinkr.fr")
